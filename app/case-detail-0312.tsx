...
const TIMELINE: { label: string; date: string; desc: string; state: StepState }[] = [
  ...
  { label: '종결',   date: '—',    desc: '보험금 지급 완료',     state: 'pending' },
];
...
export default function CaseDetail0312Screen() {
      ...
      >
        ...
        <View className="bg-white rounded-2xl p-4 mb-2.5" style={CARD_SHADOW}>
          <View className="flex-row justify-between items-center mb-1.5">
            ...
            >
              <Text
                ...
                style={{ color: colors.chip.orangeFg, letterSpacing: -0.2 }}
              >
                심사 중
              </Text>
            </View>
          ...
          >
            <Image
              ...
              style={{ width: 18, height: 18, marginTop: 1, tintColor: colors.chip.orangeFg }}
            />
            <View className="flex-1">
              <Text
                className="text-[13px] font-bold mb-0.5"
                style={{ color: colors.chip.orangeFg, letterSpacing: -0.3 }}
              >
                심사 진행 중 · 결과 대기
              </Text>
              <Text
                className="text-[12px]"
                style={{ color: colors.chip.orangeFg, opacity: 0.75, letterSpacing: -0.2 }}
              >
                근로복지공단에서 심사 진행 중입니다
              </Text>
            </View>
        ...
        <View className="bg-white rounded-2xl p-4" style={CARD_SHADOW}>
          <View className="flex-row justify-between items-center mb-4">
            ...
            >
              {'3건 · '}
              <Text style={{ color: colors.success, fontWeight: '700' }}>1건 처리</Text>
            </Text>
          </View>
